    ...
    class Xcode
      ...
      class PodsProjectGenerator
        ...
        def generate!
          ...
          integrate_targets(@target_installation_results.first)
        ...
        def write
          UI.message "- Writing Xcode project file to #{UI.path sandbox.project_path}" do
            ...
            pod_target_installation_results = @target_installation_results.first.values
        ...
        def install_libraries
          UI.message '- Installing targets' do
            ...
            return [pod_target_installation_results, aggregate_target_installation_results]
          end
        end
        ...
        def add_system_framework_dependencies(pod_target_installation_results)
          pod_target_installation_results.each do |target_installation_result|
        ...
        #         the installation results array that was produced including pod target installation results and
        #         aggregate target installation results.
        #
        # @return [void]
        #
        def wire_target_dependencies(target_installation_results)
          frameworks_group = project.frameworks_group
          pod_target_installation_results_hash = target_installation_results.first
          aggregate_target_installation_results_hash = target_installation_results.last
          ...
          aggregate_target_installation_results_hash.values.each do |aggregate_target_installation_result|
            ...
            # Wire up dependencies that are part of inherit search paths.
          ...
          pod_target_installation_results_hash.values.each do |pod_target_installation_result|
            ...
            # Wire up all dependencies, if any.
