        ...
        class PodTargetInstaller < TargetInstaller
          ...
          def install!
            UI.message "- Installing target `#{target.name}` #{target.platform}" do
              ...
              create_test_xcconfig_files(test_native_targets, test_resource_bundle_targets) if target.contains_test_specifications?
            ...
            target.file_accessors.each do |file_accessor|
              ...
              native_target = if !consumer.spec.test_specification?
                                ...
                                test_native_targets.find do |test_native_target|
                                  test_native_target.symbol_type == target.product_type_for_test_type(consumer.spec.test_type)
                                end
                              end
          ...
          def add_test_app_host_targets(test_native_targets)
            target.test_specs.map do |test_spec|
              ...
              test_native_target = test_native_targets.find do |native_target|
